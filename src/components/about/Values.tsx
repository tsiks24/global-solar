  ...
  return (
    <div className='flex flex-col w-full justify-center items-center py-[50px]'>
           <div className='flex flex-col w-[95%] lg:w-[80%]'>
            <div className='py-4 text-[20px] text-center'><h1>Our Values</h1></div>
             <div className='py-4 font-bold text-[40px] text-center'><h1>Clean Energy, Clear Commitment</h1></div>
             ...
             <div className='flex flex-row pt-10 w-full gap-20'>
                <div className='flex-1 relative bg-cover bg-no-repeat rounded-xl' style={{backgroundImage:'url(/hm.jpg)'}}>
                  
                   <div className='absolute bottom-5 left-5 right-[-6px] rounded-xl border-white border-[10px]  text-[#6bd408] bg-black p-10'> <h1 className='text-[20px]'>Innovation in product and service quality</h1></div>
                </div>
